...
class Checker(Node):
    ...
    def send_goal_total_sum(self, goal_sum):
        ...
        self.send_goal_future.add_done_callback(self.get_arithmetic_action_goal) #goal이 수락되었는지 확인
        return True
    ...
    def get_arithmetic_action_goal(self, future):
        ...
        self.action_result_future = goal_handle.get_result_async() #결과 받을 준비
        self.action_result_future.add_done_callback(self.get_arithmetic_action_result) #결과 받으면 콜백함수 실행
